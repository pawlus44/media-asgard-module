...
use Modules\Media\Blade\DocumentMultipleDirective;
...
class MediaServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('document.single.directive', function () {
            return new DocumentSingleDirective();
        });
        $this->app->bind('document.multiple.directive', function () {
            return new DocumentMultipleDirective();
        });
    ...
    private function registerBladeTags()
    {
        ...
        $this->app['blade.compiler']->directive('documentSingle', function ($value) {
            return "<?php echo DocumentSingleDirective::show([$value]); ?>";
        });
        $this->app['blade.compiler']->directive('documentMultiple', function ($value) {
            return "<?php echo DocumentMultipleDirective::show([$value]); ?>";
        });
    }
}
