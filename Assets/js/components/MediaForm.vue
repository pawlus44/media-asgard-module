                        ...
                        <div class="box-body">
                            <el-tabs v-model="activeTab">
                                <el-tab-pane :label="localeArray.name" v-for="(localeArray, locale) in locales"
                                    ...
                                    <el-form-item :label="trans('media.form.name')"
                                                  :class="{'el-form-item is-error': form.errors.has(locale + '.name') }">
                                        <el-input v-model="media[locale].name"></el-input>
                                    ...
                                    <el-form-item :label="trans('media.form.published_at')"
                                                  :class="{'el-form-item is-error': form.errors.has('published_at') }">
                                        <el-input v-model="published_at"></el-input>
                                        <div class="el-form-item__error" v-if="form.errors.has('published_at')"
                                             v-text="form.errors.first('published_at')"></div>
                                    </el-form-item>
            ...
            fetchMedia() {
                ...
                axios.get(route('api.media.media.find', { media: this.$route.params.mediaId }))
                    .then((response) => {
                        ...
                        this.published_at = response.data.data.published_at;
                    });
            },
            onSubmit() {
                this.form = new Form(_.merge(this.media, { tags: this.tags, published_at: this.published_at }));
                this.loading = true;
