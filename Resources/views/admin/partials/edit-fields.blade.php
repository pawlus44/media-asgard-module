<?php $altAttribute = isset($file->translate($lang)->name) ? $file->translate($lang)->name : '' ?>
<div class='form-group{{ $errors->has("{$lang}[name]") ? ' has-error' : '' }}'>
    {!! Form::label("{$lang}[name]", trans('media::media.form.name')) !!}
    {!! Form::text("{$lang}[name]", old("{$lang}[name]", $altAttribute), ['class' => 'form-control', 'placeholder' => trans('media::media.form.name')]) !!}
