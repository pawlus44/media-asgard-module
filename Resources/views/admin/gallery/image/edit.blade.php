...
@section('content')
{!! Form::open(['route' => ['admin.media.gallery.image.update', $gallery->id, $file->id], 'method' => 'put']) !!}
<div class="row">
    <div class="col-md-8">
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <div class="box-footer">
                    ...
                    <a class="btn btn-danger pull-right btn-flat" href="{{ URL::route('admin.media.gallery.images',[$gallery->id])}}"><i class="fa fa-times"></i> {{ trans('core::core.button.cancel') }}</a>
